...
class AnalyticsModule {
  ...
  fun provideIndicativeEventList() =
      listOf(
          ...
          BillingAnalytics.WALLET_PRESELECTED_PAYMENT_METHOD,
          BillingAnalytics.WALLET_PAYMENT_METHOD,
          BillingAnalytics.WALLET_PAYMENT_CONFIRMATION,
          BillingAnalytics.WALLET_PAYMENT_CONCLUSION,
          BillingAnalytics.WALLET_PAYMENT_START,
          BillingAnalytics.WALLET_PAYPAL_URL,
          BillingAnalytics.WALLET_PAYMENT_METHOD_DETAILS,
          BillingAnalytics.WALLET_PAYMENT_BILLING,
          WALLET_TOP_UP_START,
          WALLET_TOP_UP_SELECTION,
          WALLET_TOP_UP_CONFIRMATION,
          WALLET_TOP_UP_CONCLUSION,
          WALLET_TOP_UP_PAYPAL_URL,
          WALLET_TOP_UP_BILLING,
          WalletsAnalytics.WALLET_BACKUP_CREATE,
          WalletsAnalytics.WALLET_BACKUP_INFO,
          WalletsAnalytics.WALLET_BACKUP_CONFIRMATION,
          WalletsAnalytics.WALLET_BACKUP_CONCLUSION,
          ...
          WALLET_RATING_WELCOME_EVENT,
          WALLET_RATING_POSITIVE_EVENT,
          WALLET_RATING_NEGATIVE_EVENT,
          WALLET_RATING_FINISH_EVENT,
          START_EVENT,
          INSERT_CARD_EVENT,
          REQUEST_CONCLUSION_EVENT,
          CONFIRM_EVENT,
          CONCLUSION_EVENT,
  ...
  companion object {
    ...
    const val WALLET_PAYMENT_LOADING_TOTAL =
        "wallet_payment_loading_total" // PaymentMethodAnalytics
