...
import com.appcoins.wallet.core.utils.jvm_common.Duration.DurationUnits.addExact
import com.appcoins.wallet.core.utils.jvm_common.Duration.DurationUnits.floorDiv
import com.appcoins.wallet.core.utils.jvm_common.Duration.DurationUnits.floorMod
import com.appcoins.wallet.core.utils.jvm_common.Duration.DurationUnits.multiplyExact
...
class Duration private constructor(val seconds: Long, val nano: Int) : Comparable<Duration>,
  ...
  companion object {
    ...
    private fun create(
      negate: Boolean, daysAsSecs: Long, hoursAsSecs: Long, minsAsSecs: Long,
      secs: Long, nanos: Int
    ): Duration {
    ...
    private fun create(seconds: BigDecimal): Duration {
      ...
      return ofSeconds(
        divRem[0].toLong(), divRem[1].toInt()
          .toLong()
      )
    }
