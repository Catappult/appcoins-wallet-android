...
class Log private constructor() {
  ...
  companion object {
    ...
    @JvmStatic fun i(tag: String, msg: String): Int = if (BuildConfig.DEBUG) Log.i(tag, msg) else 0

    @JvmStatic fun d(tag: String, msg: String): Int = if (BuildConfig.DEBUG) Log.d(tag, msg) else 0

    @JvmStatic
    fun d(tag: String, msg: String, throwable: Throwable): Int =
        if (BuildConfig.DEBUG) Log.d(tag, msg, throwable) else 0

    @JvmStatic fun w(tag: String, msg: String): Int = if (BuildConfig.DEBUG) Log.w(tag, msg) else 0
    ...
    @JvmStatic fun e(tag: String, msg: String): Int = Log.e(tag, msg)
  }
}
