...
object HostProperties {
  ...
  val BACKEND_HOST_NAME = if (BuildConfig.DEBUG) BACKEND_HOST_NAME_DEV else BACKEND_HOST_NAME_PROD
...
private const val BACKEND_HOST_NAME_PROD = "apichain.catappult.io"
private const val BACKEND_HOST_NAME_DEV = "apichain.dev.catappult.io"
