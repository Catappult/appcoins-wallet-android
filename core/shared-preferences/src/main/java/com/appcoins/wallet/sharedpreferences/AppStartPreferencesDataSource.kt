...
constructor(private val sharedPreferences: SharedPreferences) {
  ...
  fun saveIsFirstPayment(isFirstPayment: Boolean) =
      sharedPreferences.edit().putBoolean(IS_FIRST_PAYMENT, isFirstPayment).apply()
