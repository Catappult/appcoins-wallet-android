...
class TransactionsSharedPreferences @Inject constructor(
  private val sharedPreferences: SharedPreferences
) {
  fun isOldTransactionsLoaded(): Boolean {
    return sharedPreferences.getBoolean(OLD_TRANSACTIONS_LOAD, false)
  }
