...
data class SubscriptionResponse(
    val sku: String,
    val period: String,
    @SerializedName("trial_period") val trialPeriod: String?,
    val title: String,
    val description: String,
    @SerializedName("price") val subscriptionPrice: SubscriptionPrice
)
 ...
 * @param verification The subscription purchase verification object, to be used by the in-app
 *   seller to cryptographically verify the subscription purchase, in order to acknowledge and
 *   activate it.
 */
data class SubscriptionPurchaseResponse(
    ...
    @SerializedName("order_uid") val orderUid: String,
