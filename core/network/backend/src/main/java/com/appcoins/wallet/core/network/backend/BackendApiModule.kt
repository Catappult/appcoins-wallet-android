...
class BackendApiModule {
  ...
  @Singleton
  @Provides
  fun providesIpCountryCodeApi(@BackendDefaultRetrofit retrofit: Retrofit): IpApi {
    return retrofit.create(IpApi::class.java)
  }

  @Singleton
  @Provides
  fun providesOffChainTransactionsApi(@BlockchainHttpClient client: OkHttpClient): TransactionsApi {
  ...
  @Provides
  fun provideGamificationApi(@DefaultHttpClient client: OkHttpClient): GamificationApi {
    val gson =
        GsonBuilder()
  ...
  @Singleton
  @Provides
  fun providesPromoCodeBackendApi(@BackendDefaultRetrofit retrofit: Retrofit): PromoCodeApi {
    return retrofit.create(PromoCodeApi::class.java)
  }

  @Singleton
  @Provides
  fun providesRedeemGiftBackendApi(@BackendDefaultRetrofit retrofit: Retrofit): RedeemGiftApi {
    return retrofit.create(RedeemGiftApi::class.java)
  }

  @Singleton
  @Provides
  fun providesWalletInfoApi(@BackendDefaultRetrofit retrofit: Retrofit): WalletInfoApi {
  ...
  @Singleton
  @Provides
  fun providesCachedBackupApi(@BackendDefaultRetrofit retrofit: Retrofit): CachedBackupApi {
    return retrofit.create(CachedBackupApi::class.java)
  }

  @Singleton
  @Provides
  fun providesBackupLogApi(@BackendDefaultRetrofit retrofit: Retrofit): BackupLogApi {
    return retrofit.create(BackupLogApi::class.java)
  }

  @Singleton
  @Provides
  fun provideTokenToFiatApi(@BackendBlockchainRetrofit retrofit: Retrofit): TokenToFiatApi {
    return retrofit.create(TokenToFiatApi::class.java)
  }

  @Singleton
  @Provides
  fun provideGasService(@BackendBlockchainRetrofit retrofit: Retrofit): GasServiceApi {
    return retrofit.create(GasServiceApi::class.java)
  }

  @Singleton
  @Provides
  fun provideAutoUpdateApi(@BackendShortTimeoutRetrofit retrofit: Retrofit): AutoUpdateApi {
  ...
  @Singleton
  @Provides
  fun provideWithdrawApi(@BackendDefaultRetrofit retrofit: Retrofit): WithdrawApi {
    return retrofit.create(WithdrawApi::class.java)
  }

  @Singleton
  @Provides
  fun provideTransactionApi(@BackendDefaultRetrofit retrofit: Retrofit): TransactionOverviewApi {
    return retrofit.create(TransactionOverviewApi::class.java)
  }

  @Singleton
  @Provides
  fun providesGamesApi(@BackendDefaultRetrofit retrofit: Retrofit): GamesApi {
