...
package com.appcoins.wallet.core.network.eskills.downloadmanager.utils.utils.design;
...
@Deprecated public class ShowMessage {
  ...
  @Nullable private static View getViewFromActivity(Activity activity) {
    ...
    if (view == null) {
      Logger.getInstance()
          .e(TAG, new IllegalStateException("Unable to find a view to bind this snack too"));
      return null;
    }
    return view;
  }
