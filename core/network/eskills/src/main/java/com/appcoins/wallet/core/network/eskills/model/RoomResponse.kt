...
sealed class RoomResponse {
  ...
  data class SuccessfulRoomResponse(
      ...
      @SerializedName("room_result") var roomResult: RoomResult,
      @SerializedName("current_user") var currentUser: User,
      @SerializedName("package_name") var packageName: String,
      @SerializedName("status") override var status: RoomStatus,
