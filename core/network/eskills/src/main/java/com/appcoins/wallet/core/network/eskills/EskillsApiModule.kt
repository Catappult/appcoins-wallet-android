...
class EskillsApiModule {
  ...
  @Singleton
  @Provides
  fun provideBdsApiSecondary(@Named("eskills-default") retrofit: Retrofit): RoomApi {
    return retrofit.create(RoomApi::class.java)
  }

  @Provides
  fun providesTicketsRepository(@Named("eskills-default") retrofit: Retrofit): TicketApi {
    return retrofit.create(TicketApi::class.java)
  }

  @Provides
  fun providePlayerStats(@Named("eskills-default") retrofit: Retrofit): GeneralPlayerStatsApi {
    return retrofit.create(GeneralPlayerStatsApi::class.java)
  }

  @Provides
  fun provideBonusPrize(@Named("eskills-default") retrofit: Retrofit): BonusPrizeApi {
