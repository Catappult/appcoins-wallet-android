...
public class Install {
  ...
  public boolean isFailed() {
    return state == InstallationStatus.GENERIC_ERROR
        || state == InstallationStatus.INSTALLATION_TIMEOUT
        || state == InstallationStatus.NOT_ENOUGH_SPACE_ERROR;
  }

  public boolean hasDownloadStarted() {
    return !(state == InstallationStatus.IN_QUEUE
        || state == InstallationStatus.INITIAL_STATE
        || state == InstallationStatus.PAUSED);
  }
  ...
  public enum InstallationStatus {
    DOWNLOADING, PAUSED, INSTALLED, UNINSTALLED, INSTALLATION_TIMEOUT, GENERIC_ERROR,
    NOT_ENOUGH_SPACE_ERROR, INITIAL_STATE, IN_QUEUE, INSTALLING
  }
