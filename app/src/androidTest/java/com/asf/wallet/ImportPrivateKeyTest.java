...
@RunWith(AndroidJUnit4.class) public class ImportPrivateKeyTest {
    /*
    Keystore
  ...
  @Test public void privateKeyToKeystoreTest()
      throws UnsupportedEncodingException, CipherException, JsonProcessingException {
    ...
    //assert (w.getAddress()
    //    .equals("7d788fc8df7165b11a19f201558fcc3590fd8d97"));
  }
}
