...
public class ChangeTokenCollectionAdapter extends RecyclerView.Adapter<TokenChangeHolder> {
    ...
    public ChangeTokenCollectionAdapter(
            OnTokenClickListener onTokenClickListener, OnTokenClickListener onTokenDeleteClickListener) {
        this.onTokenClickListener = onTokenClickListener;
        this.onTokenDeleteClickListener = onTokenDeleteClickListener;
    }

    @Override
    public TokenChangeHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TokenChangeHolder holder, int position) {
