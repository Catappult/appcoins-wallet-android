...
public class TokenTicker implements Parcelable {
  public static final Creator<TokenTicker> CREATOR = new Creator<TokenTicker>() {
    @Override public TokenTicker createFromParcel(Parcel in) {
      return new TokenTicker(in);
    }

    @Override public TokenTicker[] newArray(int size) {
  ...
  @SerializedName("percent_change_24h") public final String percentChange24h;
