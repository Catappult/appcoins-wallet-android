package com.asf.wallet.ui.widget.holder;
...
import com.asf.wallet.ui.widget.adapter.WalletsAdapter;
...
public class WalletHolder extends BinderViewHolder<Wallet> implements View.OnClickListener {
  ...
  @Override public void bind(@Nullable Wallet data, @NonNull Bundle addition) {
    wallet = null;
  ...
  public void setOnSetWalletDefaultListener(
      WalletsAdapter.OnSetWalletDefaultListener onSetWalletDefaultListener) {
    this.onSetWalletDefaultListener = onSetWalletDefaultListener;
  }

  public void setOnWalletDeleteListener(
      WalletsAdapter.OnWalletDeleteListener onWalletDeleteListener) {
    this.onWalletDeleteListener = onWalletDeleteListener;
  }

  public void setOnExportWalletListener(
