...
class TopUpDefaultValueUseCase
@Inject
constructor(
  ...
  override suspend fun getVariant(): Int? =
  ...
  override suspend fun setImpressed() =
      withContext(ioDispatcher) { featureFlagsRepository.sendImpression(FEATURE_FLAG_ID, userId) }

  suspend fun setTopUpWith(appcValue: Double) =
      withContext(ioDispatcher) {
