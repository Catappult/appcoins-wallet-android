...
import static com.asfoundation.wallet.advertise.PoAServiceConnector.ACTION_ACK_BROADCAST;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.MSG_REGISTER_CAMPAIGN;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.MSG_SEND_PROOF;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.PARAM_APP_PACKAGE_NAME;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.PARAM_APP_SERVICE_NAME;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.PARAM_WALLET_PACKAGE_NAME;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.PREFERENCE_SDK_PCKG_NAME;
import static com.asfoundation.wallet.advertise.PoAServiceConnector.SHARED_PREFS;
...
public class WalletPoAService extends Service {
    ...
    PoAServiceConnector serviceConnector;
    ...
    public void onCreate() {
        super.onCreate();
        serviceConnector = new PoAServiceConnectorImpl();
    }
        ...
        if (!isBound && intent != null) {
            if (intent.hasExtra(PARAM_APP_PACKAGE_NAME)) {
                ...
                Log.e(TAG, "Received broadcast for handshake package name: "
                        + appPackageName + " and service: " + appServiceName);
