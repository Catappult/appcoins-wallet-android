...
import com.asfoundation.wallet.iab.payment_manager.payment_methods.AmazonPayPaymentMethod

class AmazonPayFactory : PaymentMethodFactory {

  companion object {
    private const val ID = "amazonpay"
  }
