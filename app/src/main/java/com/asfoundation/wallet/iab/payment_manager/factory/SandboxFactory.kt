...
import com.asfoundation.wallet.iab.payment_manager.payment_methods.SandboxPaymentMethod

class SandboxFactory : PaymentMethodFactory {

  companion object {
    private const val ID = "sandbox"
  }
