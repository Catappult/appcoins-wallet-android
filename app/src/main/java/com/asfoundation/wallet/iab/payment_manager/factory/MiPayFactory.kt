...
import com.asfoundation.wallet.iab.payment_manager.payment_methods.MiPayPaymentMethod

class MiPayFactory : PaymentMethodFactory {

  companion object {
    private const val ID = "mipay"
  }
