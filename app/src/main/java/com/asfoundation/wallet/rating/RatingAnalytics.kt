...
class RatingAnalytics @Inject constructor(private val analyticsManager: AnalyticsManager) {
  ...
  fun sendWelcomeActionEvent(action: String) {
    ...
    analyticsManager.logEvent(
        eventData, WALLET_RATING_WELCOME_EVENT, AnalyticsManager.Action.CLICK, WALLET_CONTEXT)
  }
  ...
  fun sendPositiveActionEvent(action: String, firstTime: Boolean) {
    ...
    analyticsManager.logEvent(
        eventData, WALLET_RATING_POSITIVE_EVENT, AnalyticsManager.Action.CLICK, WALLET_CONTEXT)
  }
  ...
  fun sendNegativeActionEvent(action: String) {
    ...
    analyticsManager.logEvent(
        eventData, WALLET_RATING_NEGATIVE_EVENT, AnalyticsManager.Action.CLICK, WALLET_CONTEXT)
  }
