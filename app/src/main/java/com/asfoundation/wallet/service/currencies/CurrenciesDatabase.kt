...
@Database(entities = [CurrencyConversionRateEntity::class, FiatCurrency::class], version = 2)
...
//        database.execSQL(
//            "CREATE TABLE IF NOT EXISTS 'FiatCurrency' ('currency' TEXT NOT "
//                + "NULL, 'flag' TEXT, 'label' TEXT, 'sign' TEXT, PRIMARY KEY(currency))")
      }
    }
  }
}