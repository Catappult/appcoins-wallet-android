...
@BoundTo(
    supertype = CarrierBillingPreferencesRepository::class, component = SingletonComponent::class)
class SecureCarrierBillingPreferencesRepository
@Inject
constructor(private val securePreferencesDataSource: SecurePreferencesDataSource) :
