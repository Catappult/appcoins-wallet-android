...
class ShareLinkInteractor
@Inject
constructor(
    private val remoteRepository: ShareLinkRepository,
  ...
  fun getLinkToShare(
    ...
    return walletInteractor.find().flatMap {
      remoteRepository.getLink(
          domain, skuId, message, it.address, originalAmount, originalCurrency, paymentMethod)
    }
  }
