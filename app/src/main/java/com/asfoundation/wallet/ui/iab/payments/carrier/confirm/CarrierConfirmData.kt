...
class CarrierConfirmData(val domain: String, val skuDescription: String,
                         ...
                         val currency: String, val totalFiatAmount: BigDecimal,
                         val totalAppcAmount: BigDecimal, val bonusAmount: BigDecimal,
                         val feeFiatAmount: BigDecimal, val carrierName: String,
