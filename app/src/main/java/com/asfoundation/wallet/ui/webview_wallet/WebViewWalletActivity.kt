...
@AndroidEntryPoint
class WebViewWalletActivity : AppCompatActivity() {
  ...
  private val viewModel: WebViewWalletViewModel by viewModels()
  ...
  fun MainContent(url: String) {
    Log.d("WebViewWallet", "starting Wallet url: $url")
    ...
    Column(
      ...
      when (val uiState = viewModel.uiState.collectAsState().value) {
        is WebViewWalletViewModel.UiState.FinishActivity -> {
          Log.d(TAG, "FinishActivity")
          finishActivity()
        }

        is WebViewWalletViewModel.UiState.FinishWithError -> {
