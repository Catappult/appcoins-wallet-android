...
class TransferFragmentPresenter(
  private val view: TransferFragmentView,   //TODO remove
              ...
              makeTransaction(data)
                ...
                .flatMapCompletable { status ->
                  handleTransferResult(
                    data.currency, status, data.walletAddress,
                    data.amount
                  )
                }
                .andThen {
  ...
  private fun handleTransferResult(
    ...
    walletAddress: String, amount: BigDecimal
  ): Completable {
  ...
  private fun handleSuccess(
    currency: Currency, walletAddress: String,
    amount: BigDecimal
  ): Completable {
