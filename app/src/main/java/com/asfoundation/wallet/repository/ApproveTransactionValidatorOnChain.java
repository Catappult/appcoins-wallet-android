...
public class ApproveTransactionValidatorOnChain implements TransactionValidator {
  ...
  public ApproveTransactionValidatorOnChain(SendTransactionInteract sendTransactionInteract,
