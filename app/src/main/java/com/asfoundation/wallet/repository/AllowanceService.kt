...
constructor(
  ...
  fun checkAllowance(owner: String, spender: String, tokenAddress: String): Single<BigDecimal> {
    return defaultTokenProvider.defaultToken.map { tokenInfo: TokenInfo ->
  ...
  private fun callSmartContractFunction(
    ...
    return web3jProvider.default.ethCall(transaction, DefaultBlockParameterName.LATEST).send().value
  }

  companion object {
    private fun allowance(owner: String, spender: String): Function {
      return Function(
          "allowance",
