...
class BillingAddressInteractor(private val adyenPaymentInteractor: AdyenPaymentInteractor,
  ...
  fun makePayment(model: BillingPaymentModel,
    ...
    return adyenPaymentInteractor.makePayment(model.adyenPaymentMethod, model.shouldStoreMethod,
  ...
  fun makeTopUpPayment(model: BillingPaymentTopUpModel,
    ...
    return adyenPaymentInteractor.makeTopUpPayment(model.adyenPaymentMethod,
        model.shouldStoreMethod, model.hasCvc, model.supportedShopperInteraction, model.returnUrl,
        model.value, model.currency, model.paymentType, model.transactionType, model.packageName,
        adyenBillingAddress)
  }
