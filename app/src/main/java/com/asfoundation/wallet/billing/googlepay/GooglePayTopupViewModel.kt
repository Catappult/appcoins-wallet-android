...
constructor(
  ...
  fun startPayment(
    ...
    if (shouldStartPayment) {
      ...
      topUpAnalytics.sendConfirmationEvent(
          amount.toDouble(), "top_up", PaymentMethodsAnalytics.PAYMENT_METHOD_GOOGLEPAY_WEB)
              ...
              .subscribe(
                  {},
                  {
                    ...
                    topUpAnalytics.sendGooglePayErrorEvent(
                        errorDetails = "GooglePay transaction error")
  ...
  private fun waitForSuccess(uid: String?, amount: String, wasNonSuccess: Boolean = false) {
