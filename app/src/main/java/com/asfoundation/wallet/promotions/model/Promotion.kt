...
sealed class PerkPromotion(override val id: String, open val startDate: Long?,
                           open val endDate: Long,
                           open val detailsLink: String?) : Promotion(id)
...
data class VoucherItem(override val id: String,
