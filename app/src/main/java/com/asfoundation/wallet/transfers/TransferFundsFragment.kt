...
class TransferFundsFragment : BasePageViewFragment() {
  @Inject lateinit var transferNavigator: TransferFragmentNavigator
  ...
  fun NavigationTransfer() {
    Row(
        modifier =
            Modifier.background(shape = CircleShape, color = styleguide_blue_secondary)
  ...
  fun AmountTextField() {
    ...
    WalletTextField(
        ...
        backgroundColor = styleguide_blue_secondary,
        keyboardType = KeyboardType.Decimal) { newAmount ->
          amount = newAmount
    ...
    Card(colors = CardDefaults.cardColors(containerColor = styleguide_blue_secondary)) {
      Column(
          ...
          horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Image(
                modifier =
                    Modifier.background(color = styleguide_white, shape = RoundedCornerShape(16.dp))
                        .size(200.dp)
                        .padding(8.dp),
