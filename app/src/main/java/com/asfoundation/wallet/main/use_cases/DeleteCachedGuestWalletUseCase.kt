...
class DeleteCachedGuestWalletUseCase
@Inject
constructor(
  ...
  operator fun invoke(): Completable {
    return getCurrentWallet()
        .flatMap { wallet -> ewtObtainer.getEwtAuthenticationWithAddress(wallet.address) }
        .flatMapCompletable { ewt -> cachedGuestWalletRepository.deleteCachedGuestWallet(ewt) }
  }
}
