...
constructor(
  ...
  operator fun invoke(): Observable<Boolean> {
    return observeDefaultWalletUseCase().flatMap { wallet ->
      promotionsRepository
          .getGamificationStats(wallet.address, null)
          .takeUntil { it.gamificationStatus != GamificationStatus.NONE }
          .map { stats ->
