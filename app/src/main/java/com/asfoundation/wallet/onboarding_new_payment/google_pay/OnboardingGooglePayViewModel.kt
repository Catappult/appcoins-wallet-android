...
@HiltViewModel
class OnboardingGooglePayViewModel
@Inject
constructor(
  ...
  fun handleSuccess(purchaseUid: String?, transactionBuilder: TransactionBuilder) {
    ...
    events.sendGooglePaySuccessFinishEvents(
        transactionBuilder = transactionBuilder, purchaseUid ?: "")
