...
@AndroidEntryPoint
class OnboardingVkPaymentFragment :
  ...
  @Inject lateinit var navigator: OnboardingVkPaymentNavigator
  ...
  private fun showCompletedPayment() {
    binding.fragmentFirstIabTransactionCompleted.lottieTransactionSuccess.setAnimation(
  ...
  override fun onSideEffect(sideEffect: OnboardingVkPaymentSideEffect) {
    when (sideEffect) {
      ...
      is OnboardingVkPaymentSideEffect.NavigateBackToGame ->
