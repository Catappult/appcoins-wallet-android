...
class OnboardingVkPaymentNavigator @Inject constructor(private val fragment: Fragment) :
  Navigator {
  ...
  fun navigateToPaymentResult(
    ...
    navigate(
      ...
      OnboardingVkPaymentFragmentDirections.actionNavigateToOnboardingPaymentResult(
        PaymentModel(),
        transactionBuilder,
        paymentType,
        amount,
