...
import com.asfoundation.wallet.manage_wallets.bottom_sheet.ChangeActiveWalletBottomSheetSideEffect.WalletChanged
...
@HiltViewModel
class ChangeActiveWalletBottomSheetViewModel
@Inject
constructor(private val walletDetailsInteractor: WalletDetailsInteractor) :
    BaseViewModel<ChangeActiveWalletBottomSheetState, ChangeActiveWalletBottomSheetSideEffect>(
        initialState()) {
