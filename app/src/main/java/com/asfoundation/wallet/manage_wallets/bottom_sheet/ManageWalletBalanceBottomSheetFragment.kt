...
@AndroidEntryPoint
class ManageWalletBalanceBottomSheetFragment() :
    BottomSheetDialogFragment(),
    SingleStateFragment<
        ManageWalletBalanceBottomSheetState, ManageWalletBalanceBottomSheetSideEffect> {

  @Inject lateinit var navigator: ManageWalletBalanceBottomSheetNavigator
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    walletBalanceModel.let {
      views.totalBalanceValue.text =
          it.creditsOnlyFiat.amount.toString().formatMoney(it.creditsOnlyFiat.symbol, "") ?: ""
