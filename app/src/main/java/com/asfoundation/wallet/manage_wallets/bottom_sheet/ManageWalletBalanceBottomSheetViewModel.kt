...
class ManageWalletBalanceBottomSheetViewModel @Inject constructor() :
    BaseViewModel<ManageWalletBalanceBottomSheetState, ManageWalletBalanceBottomSheetSideEffect>(
        initialState()) {

  private val _uiState =
      MutableStateFlow<ManageWalletViewModel.UiState>(ManageWalletViewModel.UiState.Idle)
