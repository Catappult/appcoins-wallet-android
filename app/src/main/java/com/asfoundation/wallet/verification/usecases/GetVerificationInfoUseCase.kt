    ...
    return walletService
        ...
        .flatMap { walletModel ->
          brokerVerificationRepository.getVerificationInfo(
              walletModel.address, walletModel.signedAddress)
        }
        .flatMap { verificationInfo ->
          adyenPaymentInteractor
              .loadPaymentInfo(method, verificationInfo.value, verificationInfo.currency)
  ...
  private fun mapToVerificationIntroModel(
    ...
    val verificationInfoModel =
        VerificationInfoModel(
            ...
            verificationInfo.symbol,
            verificationInfo.value,
            verificationInfo.digits,
            verificationInfo.format,
            verificationInfo.period)
