...
JNICALL
Java_com_wallet_crypto_trustapp_controller_PasswordManager_getKeyStringFromNative(JNIEnv *env,
                                                                                  jobject thiz) {
...
JNICALL
Java_com_wallet_crypto_trustapp_controller_PasswordManager_getIvStringFromNative(JNIEnv *env,
                                                                                 jobject thiz) {
