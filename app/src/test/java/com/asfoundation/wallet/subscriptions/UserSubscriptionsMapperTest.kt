...
class UserSubscriptionsMapperTest {
  ...
  fun mapResponseTest() {
    val dateFormat = SimpleDateFormat(
      UserSubscriptionsMapper.DATE_FORMAT_PATTERN,
    ...
    val orderResponse = OrderResponse(
      TEST_GATEWAY, TEST_REFERENCE, TEST_FIAT_AMOUNT, TEST_LABEL,
    ...
    val allSubscriptions = UserSubscriptionsListResponse(
      listOf(
        activeSubResponse, expiredSubResponse, responseCanceled, responsePaused,
    ...
    val activeItem =
      SubscriptionItem(
        "sku", TEST_TITLE, Period(0, 0, 1, 0), Status.ACTIVE, expectedDate,
        expectedDate,
    ...
    val expiredItem =
      SubscriptionItem(
        "sku", TEST_TITLE, Period(0, 0, 1, 0), Status.EXPIRED, expectedDate,
        expectedDate,
    ...
    val pausedItem =
      SubscriptionItem(
        "sku", TEST_TITLE, Period(0, 0, 1, 0), Status.PAUSED, expectedDate, null,
        null,
    ...
    val gracePeriodItem =
      SubscriptionItem(
        "sku", TEST_TITLE, Period(0, 0, 1, 0), Status.GRACE, expectedDate,
        expectedDate,
        expectedDate, null, TEST_PACKAGE_NAME, TEST_TITLE, TEST_ICON, TEST_FIAT_AMOUNT,
        TEST_SYMBOL, TEST_CURRENCY, TEST_PAYMENT_TITLE, TEST_PAYMENT_ICON, TEST_APPC_AMOUNT,
        TEST_APPC_LABEL, TEST_UID, TEST_TRIALING
    ...
    val onHoldItem =
      SubscriptionItem(
        "sku", TEST_TITLE, Period(0, 0, 1, 0), Status.HOLD, expectedDate,
        expectedDate,
        expectedDate, null, TEST_PACKAGE_NAME, TEST_TITLE, TEST_ICON, TEST_FIAT_AMOUNT,
        TEST_SYMBOL, TEST_CURRENCY, TEST_PAYMENT_TITLE, TEST_PAYMENT_ICON, TEST_APPC_AMOUNT,
        TEST_APPC_LABEL, TEST_UID, TEST_TRIALING
