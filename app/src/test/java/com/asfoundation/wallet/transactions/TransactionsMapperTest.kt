...
class TransactionsMapperTest {
  ...
  private fun createTopUpTransaction(): TransactionEntity {
    return TransactionEntity(
        ...
        null,
        null,
        TransactionEntity.TransactionType.TOP_UP,
        null,
        null,
        null,
        null,
        1598535596254,
        1598535639951,
        TransactionEntity.TransactionStatus.SUCCESS,
        "312822262380000000000",
        "APPC",
        "30",
        "EUR",
  ...
  private fun createIapTransaction(): TransactionEntity {
    return TransactionEntity(
        ...
        null,
        null,
        TransactionEntity.TransactionType.IAP_OFFCHAIN,
        null,
        null,
        null,
        null,
        ...
        TransactionDetailsEntity(
            ...
            "Appcoins Trivial Drive demo sample",
            "gas"),
        Collections.emptyList(),
        "1637599586285")
  }
