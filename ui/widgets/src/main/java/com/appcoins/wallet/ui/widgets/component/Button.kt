...
fun ButtonWithText(
  ...
  val buttonModifier = if (buttonType == LARGE) modifier.fillMaxWidth().height(48.dp) else modifier
  Button(
...
fun BottomSheetButton(
  ...
  Button(
      ...
      modifier = Modifier.defaultMinSize(minHeight = 64.dp).padding(horizontal = 8.dp)) {
