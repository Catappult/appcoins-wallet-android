...
@Composable
fun WalletTextField(value: String,hintText: Int? = null, onValueChange: (String) -> Unit) {
  TextField(
    value = value,
  ...
  TextField(
    ...
    trailingIcon = {
      IconButton(onClick = { passwordVisible = !passwordVisible }) {
        Icon(
          painter = if(!passwordVisible) painterResource(R.drawable.ic_transaction_poa) else painterResource(R.drawable.ic_password_off),
...
fun IconTextField(){
  IconButton(onClick = {  }) {
    Icon(
      painter = painterResource(R.drawable.ic_transaction_poa),
      contentDescription = "show password",
      modifier = Modifier.size(22.dp),
      tint = WalletColors.styleguide_dark_grey)
  }
