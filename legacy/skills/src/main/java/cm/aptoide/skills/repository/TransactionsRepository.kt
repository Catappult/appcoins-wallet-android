...
@Inject
constructor(private val transactionOverviewApi: TransactionOverviewApi) {
  fun getTransactionList(
    ...
    return transactionOverviewApi
        .getTransactionOverviewList(wallet, transactionTypes, limit, offset)
