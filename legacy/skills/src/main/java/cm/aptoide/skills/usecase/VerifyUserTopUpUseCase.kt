...
constructor(
  ...
  private fun hasValidTransaction(transactions: List<TransactionOverviewResponse>): Boolean {
    return transactions.any { transaction -> transaction.paymentMethod !in CODAPAY_PAYMENT_METHODS }
  }

  companion object {
    val CODAPAY_PAYMENT_METHODS =
        listOf(
            "alfamart",
            "bank_transfer",
            "boleto",
