...
class AppcoinsBillingBinder(
  ...
  override fun isBillingSupported(
    apiVersion: Int, packageName: String?,
    billingType: String?
  ): Int {
  ...
  override fun getSkuDetails(
    apiVersion: Int, packageName: String?, billingType: String?,
    skusBundle: Bundle?
  ): Bundle {
    val result = Bundle()
  ...
  override fun getBuyIntent(
    ...
    { tokenContractAddress: String, iabContractAddress: String, skuDetails: List<Product> ->
      try {
  ...
  private fun validateGetBuyIntentArgs(
    apiVersion: Int, billingType: String?,
    sku: String?
  ): Boolean {
