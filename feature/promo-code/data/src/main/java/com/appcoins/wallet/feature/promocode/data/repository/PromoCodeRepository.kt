...
constructor(
  ...
  fun verifyAndSavePromoCode(promoCodeString: String): Single<PromoCode> {
    return promoCodeApi
        .getPromoCodeBonus(promoCodeString)
        ...
        .map { PromoCode(it.code, it.bonus, validity = ValidityState.ACTIVE, it.app.appName) }
        .onErrorReturn {
  ...
  fun handleErrorCodes(errorCode: Int?, promoCodeString: String): PromoCode {
            ...
            promoCodeLocalDataSource
                .savePromoCode(
                    PromoCodeBonusResponse(
                        promoCodeString, null, PromoCodeBonusResponse.App(null, null, null)),
    ...
    return PromoCode(promoCodeString, null, validity = validity, null)
  }
