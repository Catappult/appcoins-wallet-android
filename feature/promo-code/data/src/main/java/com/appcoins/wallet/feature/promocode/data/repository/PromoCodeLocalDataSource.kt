...
class PromoCodeLocalDataSource
@Inject
constructor(private val promoCodeDao: PromoCodeDao, private val rxSchedulers: RxSchedulers) {
  ...
  fun savePromoCode(
    ...
    return Single.just(
        ...
        .doOnSuccess { promoCodeEntity -> promoCodeDao.replaceSavedPromoCodeBy(promoCodeEntity) }
  ...
  fun getSavedPromoCode(): Single<PromoCode> {
    return observeSavedPromoCode().firstOrError().subscribeOn(rxSchedulers.io)
  }
