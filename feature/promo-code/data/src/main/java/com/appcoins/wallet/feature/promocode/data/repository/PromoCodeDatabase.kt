    ...
    val MIGRATION_2_3: Migration =
        object : Migration(2, 3) {
          override fun migrate(database: SupportSQLiteDatabase) {
            ...
            // add validity field
            database.execSQL(
                "CREATE TABLE PromoCodeEntity_new (code TEXT NOT NULL, bonus REAL, validityState INTEGER, appName TEXT, appPackageName TEXT, appIcon TEXT, PRIMARY KEY(code))")
            database.execSQL(
                "INSERT INTO PromoCodeEntity_new (code, bonus, validityState, appName, appPackageName, appIcon) SELECT code, bonus, expired, appName, appPackageName, appIcon FROM PromoCodeEntity")
